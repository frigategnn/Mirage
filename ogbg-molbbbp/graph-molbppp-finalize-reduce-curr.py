...
train_dataset_processed[0].edge_attr.shape
...
# threshold_class_dict={0:32, 1:117}


for gnn_type in ['GATConv', 'GCNConv', 'GINConv']:
    
    
    threshold_class_dict  = {0:25,1:110}
